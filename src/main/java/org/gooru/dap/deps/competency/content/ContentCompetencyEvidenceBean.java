...
public class ContentCompetencyEvidenceBean {
	...
	private boolean isMicroCompetency;
	...
	public boolean isMicroCompetency() {
		return isMicroCompetency;
	}

	public void setMicroCompetency(boolean isMicroCompetency) {
		this.isMicroCompetency = isMicroCompetency;
	}
