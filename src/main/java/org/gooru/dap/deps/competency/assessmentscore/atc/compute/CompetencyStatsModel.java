...
* @param courseId
*/
public CompetencyStatsModel(String userId, String classId, String courseId, Integer gradeId, String subjectCode, Integer totalCompetencies, 
		Integer completedCompetencies, Integer inprogressCompetencies, Double percentCompletion, Double percentScore, Integer month, Integer year) {
super();
this.userId = userId;
