...
public class AtcComputeImpl implements AtcCompute {
  ...
  private final GradeCompetencyStatsModel gradeCompetencyStatsModel =
      new GradeCompetencyStatsModel();
  ...
  private void computeGradeBasedUserCompetencyCompletion() {
    ...
    if (gradeCompetencyList != null && !gradeCompetencyList.isEmpty()) {
      ...
      GradeCompetencyStatsModel stats = competencyCompletionService.fetchUserCompetencyStatus(cm,
