...
public class LearnerProfileCompetencyEvidenceService {
	...
	public void insertOrUpdateLearnerProfileCompetencyEvidenceTS(LearnerProfileCompetencyEvidenceBean bean) {
		this.dao.insertOrUpdateLearnerProfileCompetencyEvidenceTS(bean);
	}

	public void insertOrUpdateLearnerProfileMicroCompetencyEvidenceTS(LearnerProfileMicroCompetencyEvidenceBean bean) {
	...
	public boolean checkIfCompetencyIsAlreadyCompletedOrMastered(LearnerProfileCompetencyEvidenceBean bean) {
		return this.dao.checkIfCompetencyIsCompletedOrMastered(bean);
	}

	public boolean checkIfMicroCompetencyIsAlreadyCompletedOrMastered(LearnerProfileMicroCompetencyEvidenceBean bean) {
