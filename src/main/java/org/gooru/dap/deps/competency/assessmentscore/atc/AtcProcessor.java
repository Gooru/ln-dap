...
public class AtcProcessor {
	...
	private CompetencyStatsService gradeCompetencyStatsService = new CompetencyStatsService(DBICreator.getDbiForDefaultDS());
	...
	private void initializeSubjectCode() {
		...
		if (subjectCode == null || subjectCode.isEmpty()) {
			LOGGER.warn("Not able to find subject code for specified course '{}' and class '{}'", courseId, classId);
