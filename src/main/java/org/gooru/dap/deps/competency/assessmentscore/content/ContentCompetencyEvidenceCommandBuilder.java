...
public final class ContentCompetencyEvidenceCommandBuilder {
	...
	public static ContentCompetencyEvidenceCommand build(AssessmentScoreEventMapper assessmentScoreEvent) {
		...
		ContentCompetencyEvidenceCommand command = new ContentCompetencyEvidenceCommand(userId, classId, courseId,
