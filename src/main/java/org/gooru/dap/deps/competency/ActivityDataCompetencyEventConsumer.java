  ...
  public void processRecord(ConsumerRecord<String, String> record) {
    ...
    try {
      ...
      ActivityDataEventMapper activityDataEvent =
          mapper.readValue(event, ActivityDataEventMapper.class);
      LOGGER.debug("event has been mapped to object:== {}", activityDataEvent.toString());
      new ActivityDataCompetencyStatsEventProcessor(activityDataEvent).process();
    } catch (IOException e) {
