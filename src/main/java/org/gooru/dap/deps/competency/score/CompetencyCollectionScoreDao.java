...
public abstract class CompetencyCollectionScoreDao {
	...
	@SqlUpdate("INSERT INTO competency_assessment_score(user_id, competency_code, competency_display_code, competency_title,"
			...
			+ " collection_score, collection_type, created_at, updated_at) VALUES (:userId, :competencyCode, :competencyDisplayCode,"
			+ " :competencyTitle, :frameworkCode, :gutCode, :classId, :courseId, :unitId, :lessonId, :latestSessionId, :collectionId,"
			+ " :collectionPathId, :collectionScore, :collectionType, :createdAt, :updatedAt) ON CONFLICT (user_id, gut_code, course_id,"
			...
			+ " competency_title = :competencyTitle, framework_code = :frameworkCode, collection_path_id = :collectionPathId, collection_score ="
