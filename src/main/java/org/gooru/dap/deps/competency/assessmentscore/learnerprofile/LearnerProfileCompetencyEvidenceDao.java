...
public abstract class LearnerProfileCompetencyEvidenceDao {
	...
	@SqlUpdate("INSERT INTO learner_profile_competency_evidence_ts(user_id, gut_code, class_id, course_id, unit_id, lesson_id, latest_session_id,"
			...
			+ " :updatedAt) ON CONFLICT (user_id, gut_code, collection_id, status) DO NOTHING")
	protected abstract void insertOrUpdateLearnerProfileCompetencyEvidenceTS(@BindBean LearnerProfileCompetencyEvidenceBean bean);
