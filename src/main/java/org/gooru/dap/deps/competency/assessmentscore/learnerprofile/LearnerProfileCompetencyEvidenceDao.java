...
public abstract class LearnerProfileCompetencyEvidenceDao {
  ...
  @SqlUpdate("INSERT INTO learner_profile_competency_evidence(user_id, gut_code, class_id, course_id, unit_id, lesson_id, latest_session_id,"
      + " collection_id, collection_path_id, collection_score, collection_type, content_source, created_at, updated_at) VALUES (:userId, :gutCode, :classId,"
      + " :courseId, :unitId, :lessonId, :latestSessionId, :collectionId, :collectionPathId, :collectionScore, :collectionType, :contentSource, :createdAt,"
      ...
      + " :collectionScore, content_source = :contentSource, updated_at = :updatedAt")
  ...
  @SqlUpdate("INSERT INTO learner_profile_micro_competency_evidence(user_id, micro_competency_code, class_id, course_id, unit_id, lesson_id, latest_session_id,"
      + " collection_id, collection_path_id, collection_score, collection_type, content_source, created_at, updated_at) VALUES (:userId, :microCompetencyCode, :classId,"
      + " :courseId, :unitId, :lessonId, :latestSessionId, :collectionId, :collectionPathId, :collectionScore, :collectionType, :contentSource, :createdAt,"
  ...
  @SqlUpdate("INSERT INTO learner_profile_micro_competency_evidence_ts(user_id, micro_competency_code, class_id, course_id, unit_id, lesson_id, latest_session_id,"
      + " collection_id, collection_path_id, collection_score, collection_type, content_source, status, created_at, updated_at) VALUES (:userId, :microCompetencyCode, :classId,"
      + " :courseId, :unitId, :lessonId, :latestSessionId, :collectionId, :collectionPathId, :collectionScore, :collectionType, :contentSource, :status, :createdAt,"
  ...
  protected abstract Double getScoreForCompetency(
      @BindBean LearnerProfileCompetencyEvidenceBean bean);
  ...
  protected abstract Double getScoreForMicroCompetency(
      @BindBean LearnerProfileMicroCompetencyEvidenceBean bean);
