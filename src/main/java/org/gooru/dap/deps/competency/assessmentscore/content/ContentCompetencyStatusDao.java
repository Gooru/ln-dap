...
public abstract class ContentCompetencyStatusDao {
	...
	protected abstract void insertOrUpdateContentComptencyStatus(@BindBean ContentCompetencyStatusBean bean);
	...
	protected abstract void insertOrUpdateContentComptencyStatusTS(@BindBean ContentCompetencyStatusBean bean);
}
