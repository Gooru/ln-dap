...
public abstract class ContentCompetencyEvidenceDao {
  ...
  @SqlUpdate("INSERT INTO content_competency_evidence(user_id, competency_code, framework_code, is_micro_competency, gut_code, class_id, course_id,"
      + " unit_id, lesson_id, latest_session_id, collection_id, collection_path_id, collection_score, collection_type, content_source, created_at, updated_at)"
      + " VALUES (:userId, :competencyCode, :frameworkCode, :microCompetency, :gutCode, :classId, :courseId, :unitId, :lessonId,"
      + " :latestSessionId, :collectionId, :collectionPathId, :collectionScore, :collectionType, :contentSource, :createdAt, :updatedAt) ON CONFLICT (user_id,"
      + " competency_code, collection_id) DO UPDATE SET latest_session_id = :latestSessionId, class_id = :classId, course_id = :courseId,"
      + " unit_id = :unitId, lesson_id = :lessonId, collection_path_id = :collectionPathId, collection_score = :collectionScore, content_source = :contentSource, "
  ...
  @SqlUpdate("INSERT INTO content_competency_evidence_ts(user_id, competency_code, framework_code, is_micro_competency, gut_code, class_id, course_id,"
      + " unit_id, lesson_id, latest_session_id, collection_id, collection_path_id, collection_score, collection_type, content_source, status, created_at, updated_at)"
      + " VALUES (:userId, :competencyCode, :frameworkCode, :microCompetency, :gutCode, :classId, :courseId, :unitId, :lessonId,"
      + " :latestSessionId, :collectionId, :collectionPathId, :collectionScore, :collectionType, :contentSource, :status, :createdAt, :updatedAt) ON CONFLICT (user_id,"
      + " competency_code, collection_id, status) DO UPDATE SET latest_session_id = :latestSessionId, collection_path_id = :collectionPathId,"
      + " collection_score = :collectionScore, content_source = :contentSource, updated_at = :updatedAt")
  ...
  protected abstract boolean checkIfCompetencyIsCompleted(
      @BindBean ContentCompetencyEvidenceBean bean);
}
