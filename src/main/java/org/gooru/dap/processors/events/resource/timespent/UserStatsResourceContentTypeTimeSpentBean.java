...
public class UserStatsResourceContentTypeTimeSpentBean {
  ...
  public static UserStatsResourceContentTypeTimeSpentBean createInstance(JsonNode jsonNode,
      ContentBean contentBean) {
    UserStatsResourceContentTypeTimeSpentBean userStatsResourceTimeSpentBean =
        new UserStatsResourceContentTypeTimeSpentBean();
