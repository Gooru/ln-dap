...
public class UserStatsQuestionTypeTimeSpentBean {
    ...
    public static UserStatsQuestionTypeTimeSpentBean createInstance(JsonNode jsonNode, ContentBean contentBean) {
        UserStatsQuestionTypeTimeSpentBean userStatsQuestionTimeSpentBean = new UserStatsQuestionTypeTimeSpentBean();
