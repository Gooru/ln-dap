...
public class QuestionTypeTimeSpentBean {
    ...
    public static QuestionTypeTimeSpentBean createInstance(JsonNode jsonNode, ContentBean contentBean) {
        ...
        questionTypeTimeSpentBean.setTimeSpent(jsonNode.at(EventMessageConstant.METRICS_TIMESPENT).longValue());
