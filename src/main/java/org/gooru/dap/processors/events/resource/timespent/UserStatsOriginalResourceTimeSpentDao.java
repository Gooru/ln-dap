...
abstract class UserStatsOriginalResourceTimeSpentDao {
    ...
    protected abstract void
        insertOrUpdate(@BindBean UserStatsOriginalResourceTimeSpentBean userStatsOriginalResourceTimeSpentBean);

    @Transaction
    protected void save(UserStatsOriginalResourceTimeSpentBean userStatsOriginalResourceTimeSpentBean) {
        this.insertOrUpdate(userStatsOriginalResourceTimeSpentBean);
    }
