...
public class UserStatsCCULCResourceTimeSpentBean {
    ...
    public static UserStatsCCULCResourceTimeSpentBean createInstance(JsonNode jsonNode, ContentBean contentBean) {
        UserStatsCCULCResourceTimeSpentBean userStatsResourceTimeSpentBean = new UserStatsCCULCResourceTimeSpentBean();
        userStatsResourceTimeSpentBean.setCourseId(jsonNode.at(EventMessageConstant.CTX_COURSE_ID).textValue());
        userStatsResourceTimeSpentBean.setUnitId(jsonNode.at(EventMessageConstant.CTX_UNIT_ID).textValue());
        userStatsResourceTimeSpentBean.setLessonId(jsonNode.at(EventMessageConstant.CTX_LESSON_ID).textValue());
        ...
        userStatsResourceTimeSpentBean.setCollectionType(jsonNode.at(EventMessageConstant.CTX_COLLECTION_TYPE).textValue());
