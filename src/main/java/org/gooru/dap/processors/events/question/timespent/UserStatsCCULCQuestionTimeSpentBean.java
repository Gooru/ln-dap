...
public class UserStatsCCULCQuestionTimeSpentBean {
  ...
  public static UserStatsCCULCQuestionTimeSpentBean createInstance(JsonNode jsonNode,
      ContentBean contentBean) {
    UserStatsCCULCQuestionTimeSpentBean userStatsQuestionTimeSpentBean =
        new UserStatsCCULCQuestionTimeSpentBean();
    ...
    userStatsQuestionTimeSpentBean
        .setQuestionId(jsonNode.get(EventMessageConstant.RESOURCE_ID).textValue());
