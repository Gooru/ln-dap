...
class UserStatsOriginalResourceTimeSpentHandler implements DBHandler {
  ...
  public static final List<String> USER_STATS_ORIGINAL_RESOURCE_MANDATORY_FIELDS = new ArrayList<>(
      Arrays.asList(EventMessageConstant.ACTIVITY_TIME, EventMessageConstant.RESOURCE_ID,
  ...
  public Repository getRepository() {
    return new UserStatsOriginalResourceTimeSpentDaoImpl(context);
  }
