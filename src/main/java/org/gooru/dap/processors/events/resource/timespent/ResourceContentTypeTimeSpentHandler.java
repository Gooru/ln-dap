...
class ResourceContentTypeTimeSpentHandler implements DBHandler {
  ...
  public static final List<String> RESOURCE_CONTENT_TYPE_MANDATORY_FIELDS = new ArrayList<>(
      Arrays.asList(EventMessageConstant.ACTIVITY_TIME, EventMessageConstant.METRICS_TIMESPENT));
