...
public class GroupCompetencyReportsProcessor {
  ...
  public void process() {
    ...
    for (ClassCompetencyStatsModel model : this.currentStatsModels) {
      ...
      if (schoolId == null) {
        // If the school id does not present for the given class then
        ...
        // Even if there is no school and groups mapped with the class,
        // at least persist the class
      ...
      if (groupId == null) {
        ...
        // grouped, then still persist class
