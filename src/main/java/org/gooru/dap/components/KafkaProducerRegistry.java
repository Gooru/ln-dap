...
public class KafkaProducerRegistry implements FinalizationAwareComponent, InitializationAwareComponent {
	...
	private Producer<String, String> initializeKafkaPublisher(KafkaProducerConfig kafkaProducerConfig) {
